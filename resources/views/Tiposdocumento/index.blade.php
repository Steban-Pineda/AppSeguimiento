...
@section('content')
    <style>
        ...
        .table-documentos { border-collapse: separate; border-spacing: 0 6px; width: 100%; }

        .table-documentos thead tr th {
        ...
        .table-documentos tbody tr td { border: none; padding: 14px 16px; vertical-align: middle; font-size: 0.88rem; }
    ...
    @if(session('error'))
        <div class="alert alert-danger alert-dismissible fade show shadow-sm mb-4" style="border-radius:12px; border-left:5px solid #e53e3e;">
    ...
    <div class="card card-documentos">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('tiposdocumento.create') }}" class="btn btn-registrar">
                    <i class="fas fa-plus-circle mr-2"></i> Agregar Tipo de Documento
                </a>
            </div>
        </div>
        ...
        <div class="card-body p-4">
            ...
            <div class="search-wrapper">
                <form action="{{ route('tiposdocumento.index') }}" method="GET">
                    <div class="d-flex align-items-center">
                        ...
                        @if(request('buscar'))
                            <a href="{{ route('tiposdocumento.index') }}" class="btn btn-limpiar ml-2">
                ...
                <table class="table table-documentos">
                    ...
                    @forelse($tipodoc as $item)
                        <tr>
                            ...
                            <td><span class="obs-text">{{ $item->Observaciones }}</span></td>
                            <td class="text-center">
                                <div class="d-flex justify-content-center" style="gap:6px;">
                                    <a href="{{ route('tiposdocumento.show', $item->NIS) }}" class="btn-ver" title="Ver detalle">
                                        <i class="fas fa-eye fa-sm"></i>
                                    </a>
                                    <a href="{{ route('tiposdocumento.edit', $item->NIS) }}" class="btn-editar" title="Editar">
        ...
        <div class="footer-info">
            <span class="text-muted small">
                ...
                Mostrando <b>{{ $tipodoc->count() }}</b> registros actuales
            </span>
            <div>
                {{ $tipodoc->appends(request()->query())->links() }}
            </div>
        </div>
    </div>
@stop
